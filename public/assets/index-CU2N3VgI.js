 ...
 */var Y_;function ES(){if(Y_)return El;Y_=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(r,o,u){var f=null;if(u!==void 0&&(f=""+u),o.key!==void 0&&(f=""+o.key),"key"in o){u={};for(var p in o)p!=="key"&&(u[p]=o[p])}else u=o;return o=u.ref,{$$typeof:s,type:r,key:f,ref:o!==void 0?o:null,props:u}}return El.Fragment=t,El.jsx=n,El.jsxs=n,El}var X_;function AS(){return X_||(X_=1,Vd.exports=ES()),Vd.exports}var M=AS(),kd={exports:{}},vt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $_;function bS(){if($_)return vt;$_=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),_=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),b=Symbol.for("react.activity"),N=Symbol.iterator;function B(O){return O===null||typeof O!="object"?null:(O=N&&O[N]||O["@@iterator"],typeof O=="function"?O:null)}var Z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},W=Object.assign,J={};function ot(O,Y,nt){this.props=O,this.context=Y,this.refs=J,this.updater=nt||Z}ot.prototype.isReactComponent={},ot.prototype.setState=function(O,Y){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,Y,"setState")},ot.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function gt(){}gt.prototype=ot.prototype;function ht(O,Y,nt){this.props=O,this.context=Y,this.refs=J,this.updater=nt||Z}var Et=ht.prototype=new gt;Et.constructor=ht,W(Et,ot.prototype),Et.isPureReactComponent=!0;var Ht=Array.isArray;function Rt(){}var C={H:null,A:null,T:null,S:null},S=Object.prototype.hasOwnProperty;function I(O,Y,nt){var rt=nt.ref;return{$$typeof:s,type:O,key:Y,ref:rt!==void 0?rt:null,props:nt}}function V(O,Y){return I(O.type,Y,O.props)}function x(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function U(O){var Y={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(nt){return Y[nt]})}var w=/\/+/g;function ie(O,Y){return typeof O=="object"&&O!==null&&O.key!=null?U(""+O.key):Y.toString(36)}function Ie(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(Rt,Rt):(O.status="pending",O.then(function(Y){O.status==="pending"&&(O.status="fulfilled",O.value=Y)},function(Y){O.status==="pending"&&(O.status="rejected",O.reason=Y)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function G(O,Y,nt,rt,yt){var St=typeof O;(St==="undefined"||St==="boolean")&&(O=null);var kt=!1;if(O===null)kt=!0;else switch(St){case"bigint":case"string":case"number":kt=!0;break;case"object":switch(O.$$typeof){case s:case t:kt=!0;break;case E:return kt=O._init,G(kt(O._payload),Y,nt,rt,yt)}}if(kt)return yt=yt(O),kt=rt===""?"."+ie(O,0):rt,Ht(yt)?(nt="",kt!=null&&(nt=kt.replace(w,"$&/")+"/"),G(yt,Y,nt,"",function(ar){return ar})):yt!=null&&(x(yt)&&(yt=V(yt,nt+(yt.key==null||O&&O.key===yt.key?"":(""+yt.key).replace(w,"$&/")+"/")+kt)),Y.push(yt)),1;kt=0;var Ce=rt===""?".":rt+":";if(Ht(O))for(var se=0;se<O.length;se++)rt=O[se],St=Ce+ie(rt,se),kt+=G(rt,Y,nt,St,yt);else if(se=B(O),typeof se=="function")for(O=se.call(O),se=0;!(rt=O.next()).done;)rt=rt.value,St=Ce+ie(rt,se++),kt+=G(rt,Y,nt,St,yt);else if(St==="object"){if(typeof O.then=="function")return G(Ie(O),Y,nt,rt,yt);throw Y=String(O),Error("Objects are not valid as a React child (found: "+(Y==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":Y)+"). If you meant to render a collection of children, use an array instead.")}return kt}function et(O,Y,nt){if(O==null)return O;var rt=[],yt=0;return G(O,rt,"","",function(St){return Y.call(nt,St,yt++)}),rt}function ft(O){if(O._status===-1){var Y=O._result;Y=Y(),Y.then(function(nt){(O._status===0||O._status===-1)&&(O._status=1,O._result=nt)},function(nt){(O._status===0||O._status===-1)&&(O._status=2,O._result=nt)}),O._status===-1&&(O._status=0,O._result=Y)}if(O._status===1)return O._result.default;throw O._result}var Pt=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Y=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(Y))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},Ft={map:et,forEach:function(O,Y,nt){et(O,function(){Y.apply(this,arguments)},nt)},count:function(O){var Y=0;return et(O,function(){Y++}),Y},toArray:function(O){return et(O,function(Y){return Y})||[]},only:function(O){if(!x(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return vt.Activity=b,vt.Children=Ft,vt.Component=ot,vt.Fragment=n,vt.Profiler=o,vt.PureComponent=ht,vt.StrictMode=r,vt.Suspense=g,vt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=C,vt.__COMPILER_RUNTIME={__proto__:null,c:function(O){return C.H.useMemoCache(O)}},vt.cache=function(O){return function(){return O.apply(null,arguments)}},vt.cacheSignal=function(){return null},vt.cloneElement=function(O,Y,nt){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var rt=W({},O.props),yt=O.key;if(Y!=null)for(St in Y.key!==void 0&&(yt=""+Y.key),Y)!S.call(Y,St)||St==="key"||St==="__self"||St==="__source"||St==="ref"&&Y.ref===void 0||(rt[St]=Y[St]);var St=arguments.length-2;if(St===1)rt.children=nt;else if(1<St){for(var kt=Array(St),Ce=0;Ce<St;Ce++)kt[Ce]=arguments[Ce+2];rt.children=kt}return I(O.type,yt,rt)},vt.createContext=function(O){return O={$$typeof:f,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:u,_context:O},O},vt.createElement=function(O,Y,nt){var rt,yt={},St=null;if(Y!=null)for(rt in Y.key!==void 0&&(St=""+Y.key),Y)S.call(Y,rt)&&rt!=="key"&&rt!=="__self"&&rt!=="__source"&&(yt[rt]=Y[rt]);var kt=arguments.length-2;if(kt===1)yt.children=nt;else if(1<kt){for(var Ce=Array(kt),se=0;se<kt;se++)Ce[se]=arguments[se+2];yt.children=Ce}if(O&&O.defaultProps)for(rt in kt=O.defaultProps,kt)yt[rt]===void 0&&(yt[rt]=kt[rt]);return I(O,St,yt)},vt.createRef=function(){return{current:null}},vt.forwardRef=function(O){return{$$typeof:p,render:O}},vt.isValidElement=x,vt.lazy=function(O){return{$$typeof:E,_payload:{_status:-1,_result:O},_init:ft}},vt.memo=function(O,Y){return{$$typeof:_,type:O,compare:Y===void 0?null:Y}},vt.startTransition=function(O){var Y=C.T,nt={};C.T=nt;try{var rt=O(),yt=C.S;yt!==null&&yt(nt,rt),typeof rt=="object"&&rt!==null&&typeof rt.then=="function"&&rt.then(Rt,Pt)}catch(St){Pt(St)}finally{Y!==null&&nt.types!==null&&(Y.types=nt.types),C.T=Y}},vt.unstable_useCacheRefresh=function(){return C.H.useCacheRefresh()},vt.use=function(O){return C.H.use(O)},vt.useActionState=function(O,Y,nt){return C.H.useActionState(O,Y,nt)},vt.useCallback=function(O,Y){return C.H.useCallback(O,Y)},vt.useContext=function(O){return C.H.useContext(O)},vt.useDebugValue=function(){},vt.useDeferredValue=function(O,Y){return C.H.useDeferredValue(O,Y)},vt.useEffect=function(O,Y){return C.H.useEffect(O,Y)},vt.useEffectEvent=function(O){return C.H.useEffectEvent(O)},vt.useId=function(){return C.H.useId()},vt.useImperativeHandle=function(O,Y,nt){return C.H.useImperativeHandle(O,Y,nt)},vt.useInsertionEffect=function(O,Y){return C.H.useInsertionEffect(O,Y)},vt.useLayoutEffect=function(O,Y){return C.H.useLayoutEffect(O,Y)},vt.useMemo=function(O,Y){return C.H.useMemo(O,Y)},vt.useOptimistic=function(O,Y){return C.H.useOptimistic(O,Y)},vt.useReducer=function(O,Y,nt){return C.H.useReducer(O,Y,nt)},vt.useRef=function(O){return C.H.useRef(O)},vt.useState=function(O){return C.H.useState(O)},vt.useSyncExternalStore=function(O,Y,nt){return C.H.useSyncExternalStore(O,Y,nt)},vt.useTransition=function(){return C.H.useTransition()},vt.version="19.2.1",vt}var J_;function Cm(){return J_||(J_=1,kd.exports=bS()),kd.exports}var en=Cm();const SS=K0(en);var Ud={exports:{}},Al={},Pd={exports:{}},Ld={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cx{constructor(t){this.app=t}_delete(){return delete no[this.app.options.appId],Promise.resolve()}}let no={},B0=[];const q0={};let em="dataLayer",Nx="gtag",H0,Ip,F0=!1;function Dx(){const s=[];if(nT()&&s.push("This is a browser extension environment."),tw()||s.push("Cookies are not available."),s.length>0){const t=s.map((r,o)=>`(${o+1}) ${r}`).join(" "),n=An.create("invalid-analytics-context",{errorInfo:t});nn.warn(n.message)}}function xx(s,t,n){Dx();const r=s.options.appId;if(!r)throw An.create("no-app-id");if(!s.options.apiKey)if(s.options.measurementId)nn.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${s.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw An.create("no-api-key");if(no[r]!=null)throw An.create("already-exists",{id:r});if(!F0){ux(em);const{wrappedGtag:u,gtagCore:f}=dx(no,B0,q0,em,Nx);Ip=u,H0=f,F0=!0}return no[r]=Ix(s,B0,q0,t,H0,em,n),new Cx(s)}function Ox(s=gh()){s=Ge(s);const t=rr(s,dh);return t.isInitialized()?t.getImmediate():Mx(s)}function Mx(s,t={}){const n=rr(s,dh);if(n.isInitialized()){const o=n.getImmediate();if(Zs(t,n.getOptions()))return o;throw An.create("already-initialized")}return n.initialize({options:t})}function Vx(s,t,n){s=Ge(s),wx(Ip,no[s.app.options.appId],t,n).catch(r=>nn.error(r))}function kx(s,t,n,r){s=Ge(s),Sx(Ip,no[s.app.options.appId],t,n,r).catch(o=>nn.error(o))}const G0="@firebase/analytics",Q0="0.10.19";function Ux(){ni(new Ln(dh,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),o=t.getProvider("installations-internal").getImmediate();return xx(r,o,n)},"PUBLIC")),ni(new Ln("analytics-internal",s,"PRIVATE")),fn(G0,Q0),fn(G0,Q0,"esm2020");function s(t){try{const n=t.getProvider(dh).getImmediate();return{logEvent:(r,o,u)=>kx(n,r,o,u),setUserProperties:(r,o)=>Vx(n,r,o)}}catch(n){throw An.create("interop-component-reg-failed",{reason:n})}}}Ux();const Px={apiKey:"AIzaSyAYAgWBpw0eM9R0mJlP-6C_d9PN98ZlMlI",authDomain:"doctorinan.firebaseapp.com",projectId:"doctorinan",storageBucket:"doctorinan.firebasestorage.app",messagingSenderId:"490774658788",appId:"1:490774658788:web:5c920988e08b09bafaf6f1",measurementId:"G-460BBQVRFL"},Vh=lT(Px);yI(Vh);const HA=vN(Vh);fD(Vh);typeof window<"u"&&Ox(Vh);const Lx=()=>{const[s,t]=en.useState(""),[n,r]=en.useState(""),[o,u]=en.useState(!1),[f,p]=en.useState(""),[g,_]=en.useState(!1),E=async b=>{if(b.preventDefault(),p(""),_(!1),!n.trim()){p("Please provide your contact number.");return}u(!0);try{const N=await fetch("/api/createPayment",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:n.trim(),amount:500})});if(!N.ok){const ot=await N.json();throw new Error(ot.error||"Failed to create payment")}const B=await N.json(),{paymentID:Z}=B;await new Promise(ot=>setTimeout(ot,1e3));const W=await fetch("/api/executePayment",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({paymentID:Z})});if(!W.ok){const ot=await W.json();throw new Error(ot.error||"Payment execution failed")}if((await W.json()).status!=="completed")throw new Error("Payment not completed.");await UN(oA(HA,"consultations"),{phone:n.trim(),situation:s.trim(),paid:!0,amount:500,currency:"BDT",paymentID:Z,createdAt:jN(),status:"pending"}),_(!0),t(""),r("")}catch(N){p(N.message||"Something went wrong. Please try again.")}finally{u(!1)}};return M.jsx("section",{className:"py-12 px-4 sm:px-6 lg:px-8 bg-white",children:M.jsxs("div",{className:"max-w-3xl mx-auto",children:[M.jsxs("div",{className:"text-center mb-10",children:[M.jsx("h2",{className:"text-3xl md:text-4xl font-bold text-gray-900",children:"Describe Your Medical Situation"}),M.jsx("p",{className:"mt-4 text-lg text-gray-600",children:"Fill out the form below. After submitting, you'll be directed to a secure bkash payment. Only paid consultations will be forwarded to our doctors."})]}),M.jsxs("form",{onSubmit:E,className:"space-y-6",children:[M.jsxs("div",{children:[M.jsx("label",{htmlFor:"situation",className:"block text-sm font-medium text-gray-700 mb-2",children:"Describe your symptoms or medical situation (optional)"}),M.jsx("textarea",{id:"situation",rows:4,className:"w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition",placeholder:"e.g., I have had a fever and cough for three days...",value:s,onChange:b=>t(b.target.value)}),M.jsx("p",{className:"mt-1 text-sm text-gray-500",children:"You can leave this empty if you prefer to explain over the phone."})]}),M.jsxs("div",{children:[M.jsx("label",{htmlFor:"phone",className:"block text-sm font-medium text-gray-700 mb-2",children:"Contact Number *"}),M.jsx("input",{type:"tel",id:"phone",required:!0,className:"w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition",placeholder:"+8801XXXXXXXXX",value:n,onChange:b=>r(b.target.value)}),M.jsx("p",{className:"mt-1 text-sm text-gray-500",children:"We'll call you on this number after payment confirmation."})]}),f&&M.jsx("div",{className:"p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg",children:f}),g&&M.jsxs("div",{className:"p-4 bg-green-50 border border-green-200 text-green-800 rounded-lg",children:[M.jsx("h3",{className:"font-bold text-lg",children:"Payment Successful!"}),M.jsx("p",{children:"Your consultation request has been recorded. Our admin will call you within 30 minutes."}),M.jsx("p",{className:"mt-2 text-sm",children:"A confirmation SMS will be sent to your phone shortly."})]}),M.jsxs("div",{className:"pt-4",children:[M.jsx("button",{type:"submit",disabled:o,className:"w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-4 px-6 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed",children:o?M.jsxs("span",{className:"flex items-center justify-center",children:[M.jsxs("svg",{className:"animate-spin h-5 w-5 mr-3 text-white",xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[M.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),M.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Processing..."]}):"Proceed to Payment (৳ 500)"}),M.jsx("p",{className:"mt-3 text-center text-sm text-gray-500",children:"You'll be redirected to bkash for a secure payment of ৳ 500. After successful payment, your details will be saved and our admin will call you shortly."})]})]}),M.jsxs("div",{className:"mt-12 p-6 bg-blue-50 rounded-2xl border border-blue-200",children:[M.jsx("h3",{className:"text-xl font-semibold text-blue-900 mb-2",children:"How it works:"}),M.jsxs("ul",{className:"space-y-3 text-blue-800",children:[M.jsxs("li",{className:"flex items-start",children:[M.jsx("span",{className:"inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center mr-3 flex-shrink-0",children:"1"}),M.jsx("span",{children:"Fill in your contact number and optionally describe your situation."})]}),M.jsxs("li",{className:"flex items-start",children:[M.jsx("span",{className:"inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center mr-3 flex-shrink-0",children:"2"}),M.jsx("span",{children:`Click "Proceed to Payment" – you'll be taken to bkash to pay ৳ 500.`})]}),M.jsxs("li",{className:"flex items-start",children:[M.jsx("span",{className:"inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center mr-3 flex-shrink-0",children:"3"}),M.jsx("span",{children:"After successful payment, your information is recorded in our system."})]}),M.jsxs("li",{className:"flex items-start",children:[M.jsx("span",{className:"inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center mr-3 flex-shrink-0",children:"4"}),M.jsx("span",{children:"Our admin will call you within 30 minutes to discuss further."})]})]})]})]})})},zx=()=>{const s=[{src:"/assets/inangroup.jpeg",alt:"All senior experts",title:"All senior experts"},{src:"/assets/inangroup2.jpeg",alt:"Eastern Medical College Family",title:"Eastern Medical College Family"},{src:"/assets/inangroup3.jpeg",alt:"With my Senior",title:"With my Senior"}];return M.jsx("section",{className:"py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50",children:M.jsxs("div",{className:"max-w-7xl mx-auto",children:[M.jsxs("div",{className:"text-center mb-10",children:[M.jsx("h2",{className:"text-3xl md:text-4xl font-bold text-gray-900",children:"Part of the Inan Group Family"}),M.jsx("p",{className:"mt-4 text-lg text-gray-600 max-w-3xl mx-auto",children:"These photos show our team collaborating with the wider Inan Group—a trusted network of healthcare professionals across Bangladesh. We stand together to bring you reliable, compassionate medical advice."})]}),M.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12",children:s.map((t,n)=>M.jsxs("div",{className:"bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300",children:[M.jsx("div",{className:"p-6",children:M.jsx("img",{src:t.src,alt:t.alt,className:"w-full h-auto object-contain rounded-lg",loading:"lazy"})}),M.jsxs("div",{className:"px-6 pb-6 text-center",children:[M.jsx("h3",{className:"text-xl font-semibold text-gray-800",children:t.title}),M.jsx("p",{className:"mt-2 text-gray-600",children:n===0?"Meeting with senior medical experts.":n===1?"Celebrating with Eastern Medical College family.":"A moment with my senior mentor."})]})]},n))}),M.jsx("div",{className:"mt-12 text-center",children:M.jsxs("div",{className:"inline-flex items-center justify-center p-4 bg-blue-100 rounded-full",children:[M.jsx("svg",{className:"w-6 h-6 text-blue-600 mr-3",fill:"currentColor",viewBox:"0 0 20 20",xmlns:"http://www.w3.org/2000/svg",children:M.jsx("path",{fillRule:"evenodd",d:"M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z",clipRule:"evenodd"})}),M.jsx("span",{className:"text-blue-800 font-medium",children:"Trusted by thousands of patients across Bangladesh."})]})})]})})},jx=()=>M.jsx("footer",{className:"bg-gray-800 text-white",children:M.jsxs("div",{className:"max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8",children:[M.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-8",children:[M.jsxs("div",{children:[M.jsx("h3",{className:"text-lg font-semibold",children:"DoctorInan"}),M.jsx("p",{className:"mt-2 text-gray-400 text-sm",children:"Your health partner for online medical consultations in Bangladesh."})]}),M.jsxs("div",{children:[M.jsx("h3",{className:"text-sm font-semibold tracking-wider uppercase",children:"Quick Links"}),M.jsxs("ul",{className:"mt-4 space-y-2",children:[M.jsx("li",{children:M.jsx("a",{href:"#",className:"text-base text-gray-400 hover:text-white",children:"Home"})}),M.jsx("li",{children:M.jsx("a",{href:"#admin",className:"text-base text-gray-400 hover:text-white",children:"Admin Panel"})})]})]}),M.jsxs("div",{children:[M.jsx("h3",{className:"text-sm font-semibold tracking-wider uppercase",children:"Support"}),M.jsxs("ul",{className:"mt-4 space-y-2",children:[M.jsx("li",{children:M.jsx("a",{href:"#",className:"text-base text-gray-400 hover:text-white",children:"FAQ"})}),M.jsx("li",{children:M.jsx("a",{href:"#",className:"text-base text-gray-400 hover:text-white",children:"Contact Us"})}),M.jsx("li",{children:M.jsx("a",{href:"#",className:"text-base text-gray-400 hover:text-white",children:"Privacy Policy"})})]})]}),M.jsxs("div",{children:[M.jsx("h3",{className:"text-sm font-semibold tracking-wider uppercase",children:"Website Development"}),M.jsxs("div",{className:"mt-4 space-y-2",children:[M.jsxs("p",{className:"text-base text-gray-400",children:["This website was developed by"," ",M.jsx("a",{href:"https://labinitial.com",target:"_blank",rel:"noopener noreferrer",className:"text-blue-400 hover:text-blue-300 underline",children:"labinitial.com"}),", a professional web development and SEO agency."]}),M.jsxs("p",{className:"text-base text-gray-400 mt-2",children:["Founded by ",M.jsx("strong",{className:"text-white",children:"Arafat Hossain"}),", labinitial.com specializes in creating modern, responsive websites and implementing effective SEO strategies."]})]})]})]}),M.jsxs("div",{className:"mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-400",children:[M.jsxs("p",{children:["© ",new Date().getFullYear()," DoctorInan. All rights reserved."]}),M.jsxs("p",{className:"mt-2",children:["Website developed by"," ",M.jsx("a",{href:"https://labinitial.com",target:"_blank",rel:"noopener noreferrer",className:"text-blue-400 hover:text-blue-300 underline font-medium",children:"labinitial.com"})," ","– Web Development & SEO Agency | Founder: Arafat Hossain"]})]})]})}),Bx=()=>{const[s,t]=en.useState(""),[n,r]=en.useState(!1),[o,u]=en.useState([]),[f,p]=en.useState(!0),[g,_]=en.useState(""),E="neilarmstrong",b=B=>{B.preventDefault(),s===E?(r(!0),_("")):_("Incorrect password")};en.useEffect(()=>{if(!n)return;const B=xN(oA(HA,"consultations"),ON("createdAt","desc")),Z=PN(B,W=>{const J=W.docs.map(ot=>({id:ot.id,...ot.data()}));u(J),p(!1)},W=>{console.error("Error fetching consultations:",W),_("Failed to load consultations"),p(!1)});return()=>Z()},[n]);const N=()=>{r(!1),t("")};return n?M.jsx("div",{className:"min-h-screen bg-gray-100 p-4 md:p-8",children:M.jsxs("div",{className:"max-w-7xl mx-auto",children:[M.jsxs("div",{className:"flex justify-between items-center mb-8",children:[M.jsx("h1",{className:"text-3xl font-bold text-gray-900",children:"Consultation Records"}),M.jsxs("div",{className:"flex items-center space-x-4",children:[M.jsx("span",{className:"text-gray-700",children:"Admin"}),M.jsx("button",{onClick:N,className:"bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition",children:"Logout"}),M.jsx("a",{href:"#",onClick:()=>window.location.hash="",className:"text-blue-600 hover:underline",children:"Back to site"})]})]}),f?M.jsxs("div",{className:"text-center py-12",children:[M.jsx("div",{className:"inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500"}),M.jsx("p",{className:"mt-4 text-gray-600",children:"Loading consultations..."})]}):o.length===0?M.jsx("div",{className:"bg-white rounded-xl shadow p-8 text-center",children:M.jsx("p",{className:"text-gray-700 text-lg",children:"No consultation records yet."})}):M.jsx("div",{className:"bg-white rounded-xl shadow overflow-hidden",children:M.jsx("div",{className:"overflow-x-auto",children:M.jsxs("table",{className:"min-w-full divide-y divide-gray-200",children:[M.jsx("thead",{className:"bg-gray-50",children:M.jsxs("tr",{children:[M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Date & Time"}),M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Phone"}),M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Situation"}),M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Amount"}),M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Status"}),M.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Payment ID"})]})}),M.jsx("tbody",{className:"bg-white divide-y divide-gray-200",children:o.map(B=>{var Z;return M.jsxs("tr",{className:"hover:bg-gray-50",children:[M.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-900",children:(Z=B.createdAt)!=null&&Z.toDate?B.createdAt.toDate().toLocaleString():"N/A"}),M.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900",children:B.phone}),M.jsx("td",{className:"px-6 py-4 text-sm text-gray-700 max-w-xs truncate",children:B.situation||M.jsx("span",{className:"text-gray-400",children:"(empty)"})}),M.jsxs("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-900",children:[B.currency," ",B.amount]}),M.jsx("td",{className:"px-6 py-4 whitespace-nowrap",children:M.jsx("span",{className:`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${B.status==="pending"?"bg-yellow-100 text-yellow-800":"bg-green-100 text-green-800"}`,children:B.status})}),M.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-mono",children:B.paymentID||"N/A"})]},B.id)})})]})})}),M.jsxs("div",{className:"mt-8 text-sm text-gray-500",children:[M.jsxs("p",{children:["Total records: ",o.length]}),M.jsx("p",{className:"mt-2",children:"Only paid consultations are stored. Data updates in real‑time."})]})]})}):M.jsx("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center p-4",children:M.jsxs("div",{className:"bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full",children:[M.jsx("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:"Admin Access"}),M.jsx("p",{className:"text-gray-600 mb-6",children:"Enter the password to view consultation records."}),M.jsxs("form",{onSubmit:b,children:[M.jsxs("div",{className:"mb-6",children:[M.jsx("label",{htmlFor:"password",className:"block text-sm font-medium text-gray-700 mb-2",children:"Password"}),M.jsx("input",{type:"password",id:"password",className:"w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition",placeholder:"Enter password",value:s,onChange:B=>t(B.target.value),autoFocus:!0})]}),g&&M.jsx("p",{className:"text-red-600 text-sm mb-4",children:g}),M.jsx("button",{type:"submit",className:"w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold py-3 px-6 rounded-lg hover:shadow-xl transition-all",children:"Login"})]}),M.jsx("div",{className:"mt-6 text-center",children:M.jsx("a",{href:"#",onClick:()=>window.location.hash="",className:"text-blue-600 hover:underline",children:"← Back to main site"})})]})})},qx=()=>{const[s,t]=en.useState(window.location.hash==="#admin");return en.useEffect(()=>{const n=()=>{t(window.location.hash==="#admin")};return window.addEventListener("hashchange",n),()=>window.removeEventListener("hashchange",n)},[]),s?M.jsx(Bx,{}):M.jsxs("div",{className:"bg-gray-50 min-h-screen",children:[M.jsx(MS,{}),M.jsxs("main",{children:[M.jsx(kS,{}),M.jsx(US,{}),M.jsx(Lx,{}),M.jsx(zx,{})]}),M.jsx(jx,{})]})},FA=document.getElementById("root");if(!FA)throw new Error("Could not find root element to mount to");const Hx=OS.createRoot(FA);Hx.render(M.jsx(SS.StrictMode,{children:M.jsx(qx,{})}));
